  ...
  return (
    <div className="px-2">
      ...
      {loading ? (
        ...
        <div className="py-2">
          <div className="relative bg-blue-900 p-2 flex justify-between items-center">
            ...
            <span className="absolute top-0 left-0 font-extrabold text-red-700 py-2 px-3 text-base uppercase">
              total
            </span>
          </div>
          <div className="flex items-center justify-center flex-wrap">
            <CategoryBox
              category={{ name: "all", _id: 1, color: "gray" }}
          ...
          {items.length > 0 ? (
            ...
            <div className="text-center text-2xl flex h-64 justify-center items-center font-bold bg-red-200">
